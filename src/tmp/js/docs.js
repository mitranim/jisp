...
React.createElement("div", {className: "panel panel-warning"}, 
  ...
  React.createElement("div", {className: "panel-body"}, 
    React.createElement("p", null, 
      "There's been a hiatus in updates. Mostly it's because I'm busy with other projects. Another part of the reason is that my views on JS have underwent a complete 180°. (Please mentally apply a vintage filter to everything else you read in this documentation.) JS doesn't need lispy features or macros because of its polymorphism and flexibility. Problems solved with macros are usually ", React.createElement("em", null, "better"), " solved with apt program architecture and using the language to its fullest. Preprocessors tend to be detrimental to the latter part."
    ), 

    React.createElement("p", null, 
      "When I finally get back to it, expect breaking changes. The next version (see the ", React.createElement("a", {href: "https://github.com/Mitranim/jisp/tree/0.4.0"}, "branch"), " on Github) is a complete rewrite. It drops dead-end features and Ruby influences, and focuses on the core ideas. It's almost complete, so if you're interested in taking over, let me know."
    )
  )
), 

React.createElement("blockquote", {className: "info"}, 
  React.createElement("p", null, 
...
React.createElement("h2", null, "Interactive Playground"), 
...
React.createElement(Md, null, "Example of dynamically constructing code with a macro."), 

React.createElement("h2", {id: "installation"}, "Installation and Usage"), 
...
React.createElement("h2", {id: "code-structure"}, "Code Structure"), 
...
React.createElement(Md, null, "In fact, even operators are considered functions and use the prefix notation. This allows them to take multiple arguments:"), 
...
React.createElement(Md, null, "**[NYI]** Planned feature: you'll be able to pass operators around like any other function:"), 
...
React.createElement(Md, null, "Not all lists are function calls. Some are _special forms_ with their own resolution rules. This includes assignment, quoting, function definitions, conditionals, loops, and JS keywords."), 

React.createElement("h2", {id: "everything-exp"}, "Everything an Expression"), 
...
React.createElement(Md, null, "Inside a nested form, forms are resolved left-to-right, inner-to-outer, just like you'd expect."), 

React.createElement("h2", {id: "quoting"}, "Quoting"), 

React.createElement(Md, null, "If lists resolve as function calls, how do you write array literals? The answer is quoting. The special form `(quote x)` prevents the list `x` from being resolved, letting it remain an array. Prepending a list with `` ` `` is shorthand syntax:"), 
...
React.createElement(Md, null, "Directly quoting a non-primitive atom (name or string) stringifies it:"), 
...
React.createElement(Md, null, "To let an element resolve, _unquote_ it with a comma `,`:"), 
...
React.createElement(Md, null, "Aside from writing array literals, quoting and unquoting is primarily used in macros. See the [Macros](#macros) section below."), 

React.createElement("h2", {id: "blocks"}, "Blocks and Chaining"), 

React.createElement(Md, null, "Because jisp code consists of nested expressions, even a multi-line block must be a single expression. How to make one? By wrapping several forms in the special form `do`:"), 
...
React.createElement(Md, null, "**Note**: `do` is the **only** jisp expression that can consist of multiple forms. The body of each function, loop, etc. is always a single form, and requires a `do` to include multiple expressions."), 

React.createElement("h2", {id: "object-props"}, "Object Properties"), 

React.createElement(Md, null, "As you'd expect, object properties are referenced with the `.dot` or `[bracket]` notation:"), 
...
React.createElement(Md, null, "Dot and bracket notation is a syntax shortcut to getting a property of an object. Internally, jisp uses the `(get obj prop)` special form:"), 
...
React.createElement(Md, null, "Quite naturally, you can access properties of resolved forms:"), 
...
React.createElement(Md, null, "But you can also access it with the `get` form, and `do` for chaining (below). This is useful in macros when you pass around names of objects and properties individually."), 
...
React.createElement(Md, null, "To chain methods, wrap them in a `do` form:"), 
...
React.createElement(Md, null, "Alternatively (even though it's kinda gross), you can do it like this:"), 
...
React.createElement("h2", {id: "functions"}, "Functions"), 

React.createElement(Md, null, "Jisp mirrors JavaScript function facilities 1-1 and adds some more."), 

React.createElement("h3", {id: "definition"}, "Definition"), 
...
React.createElement("h3", {id: "call-return"}, "Calling and Returning"), 

React.createElement(Md, null, "A function call is a list starting with the function's name or with a form that resolves to a function:"), 
...
React.createElement(Md, null, "A function returns the resolved value of its body. You almost never need to return values manually:"), 
...
React.createElement(Code, null, "((fn (* #0 #2)) 3 100 4)"), 

React.createElement(Md, null, "As a side effect of implicit returns, when making a prototype constructor, you need to end it with `this` as the return value to make the `new` declarations work."), 

React.createElement("h3", {id: "lambda"}, "Lambda Syntax"), 
...
React.createElement(Md, null, "This goes hand in hand with the `#` notation:"), 
...
React.createElement("h3", {id: "let"}, "Let"), 
...
React.createElement(Md, null, "Just like assignment, it takes variables in pairs:"), 
...
React.createElement(Md, null, "`let` is currently implemented as a self-executing anonymous function. In the future editions of EcmaScript, it will be changed to use the native `let` statement with a block."), 

React.createElement("h2", {id: "assignment"}, "Assignment"), 
...
React.createElement(Md, null, "The right hand of an assignment can be an arbitrary form, even a block:"), 
...
React.createElement(Md, null, "Calling `=` with a single argument merely declares that name if not already in scope:"), 

React.createElement(Code, null, "(= emptyVar)"), 

React.createElement("h2", {id: "destructuring"}, "Destructuring Assignment"), 
...
React.createElement(Code, null, "(= (smaller bigger) `(3 Infinity))"), 

React.createElement(Md, null, "This assignment is positional: `[0]` `[1]` and so on. To collect all remaining parts into an element, prefix it with `...` or `…`:"), 
...
React.createElement(Md, null, "`...x` and `…x` is a shortcut to the `(spread x)` special form, which you can, and sometimes need to, use directly. Spreading is moderately greedy: it takes as many elements as possible, but has lower priority than non-spread identifiers."), 

React.createElement("h2", {id: "spreading-rest"}, "Spreading and Rest Parameter"), 

React.createElement(Md, null, "Borrowed straight from the upcoming EcmaScript 6 specification."), 

React.createElement("h3", {id: "spread-into-list"}, "Spread Into List"), 

React.createElement(Md, null, "In a list, prefix elements with `...` or `…` to spread their elements into the list, flattening it:"), 
...
React.createElement("h3", {id: "argument-spread"}, "Argument Spread"), 

React.createElement(Md, null, "Spread a list into a function call to pass its elements as individual arguments:"), 
...
React.createElement("h3", {id: "rest-parameter"}, "Rest Parameter"), 

React.createElement(Md, null, "Prefix a parameter with `...` or `…` to make it a _rest parameter_ that collects the remaining arguments into a list. This works the same way as destructuring assignment:"), 
...
React.createElement("h2", {id: "conditionals"}, "Conditionals"), 
...
React.createElement("h3", {id: "logic"}, "Logic"), 
...
React.createElement("h3", {id: "existence"}, "Existence"), 
...
React.createElement(Md, null, "It's smart about properties: it takes property references apart and checks them in order, starting with the base object, letting you pinpoint the existence of a property with just one conditional:"), 
...
React.createElement(Md, null, "Single conditional and no runtime error."), 

React.createElement("h3", {id: "if"}, "If"), 
...
React.createElement(Md, null, "Like everything else, the block form resolves to a value that can be assigned or returned:"), 
...
React.createElement("h3", {id: "switch"}, "Switch"), 
...
React.createElement(Md, null, "Quite naturally, `switch` is also an expression that resolves to a value:"), 
...
React.createElement("h3", {id: "try-catch"}, "Try / Catch"), 
...
React.createElement(Md, null, "More conditionals coming up. The [macro](#macros) system also makes it trivial to define your own conditionals with arbitrary syntax."), 

React.createElement("h2", {id: "loops"}, "Loops"), 

React.createElement(Md, null, "Jisp abstracts away the legacy details of JavaScript loops and makes them a lot more expressive. It comes with three loops: `for`, `over`, and `while`."), 

React.createElement("h3", {id: "over"}, "Over"), 
...
React.createElement(Md, null, "`over` automatically builds a list of values from each iteration. This list is its resolved value:"), 
...
React.createElement(Md, null, "Iteration only collects results that are not `undefined`, so you can easily filter them:"), 
...
React.createElement("h3", {id: "for"}, "For"), 
...
React.createElement(Md, null, "It resolves to a list of values from each iteration. Just like `over`, it filters them by `undefined`:"), 
...
React.createElement("h3", {id: "while"}, "While"), 
...
React.createElement("h2", {id: "comprehensions"}, "Comprehensions"), 
...
React.createElement(Md, null, "`for` and `while` (see [Loops](#loops)) are list-building expressions and can be combined with `range`, and optionally `if`, to make a comprehension:"), 
...
React.createElement("h2", {id: "macros"}, "Macros"), 
...
React.createElement("h3", {id: "templating"}, "Templating"), 
...
React.createElement(Md, null, "In this example, the logic `(args.unshift ,zeroValue)` is only included if a `zeroValue` was passed to the macro. Run the resulting functions with none and one argument to see the difference."), 

React.createElement("h3", {id: "code-construction"}, "Code Construction"), 
...
React.createElement(Md, null, "Sometimes you want the code returned from a macro to contain new variable binginds. Prefix a name with `#` to make it a service name that is guaranteed to be unique in the current scope. If it clashes with any other variable, it will be renamed to avoid the conflict."), 
...
React.createElement(Md, null, "Finally, macros can self-expand on definition:"), 
...
React.createElement("h3", {id: "macro-import-export"}, "Macro Import and Export"), 
...
React.createElement("h3", {id: "macro-notes"}, "Notes"), 
...
React.createElement("h2", {id: "built-ins"}, "Built-ins and Embedding"), 

React.createElement(Md, null, "Jisp comes with some built-in macros and functions, and faculties for importing them and embedding into compiled programs."), 

React.createElement("h3", {id: "built-in-macros"}, "Macros"), 

React.createElement(Md, null, "Most built-in macros are conditionals. See the [conditionals](#conditionals) section. Some are property accessors. `prn` is a syntax-level alias for `console.log`."), 
...
React.createElement(Md, null, "`:` is a hash table builder. When given multiple arguments, it takes them as key-value pairs and compiles to an object literal:"), 

React.createElement(Code, null, "(: basic 'hash' table 'syntax')"), 

React.createElement(Md, null, "This has its use in macros (at compile time). To use the hash builder at runtime, call it with a single argument:"), 
...
React.createElement(Md, null, "`::` is particularly useful for building hashes in loops."), 
...
React.createElement("h3", {id: "built-in-functions"}, "Functions"), 
...
React.createElement("h3", {id: "function-import-export"}, "Function Import and Export"), 
...
React.createElement("h2", {id: "style"}, "Style"), 
...
React.createElement("h2", {id: "why"}, "Why Use Jisp"), 
...
React.createElement("h3", {id: "why-over"}, "Why Jisp Over [insert dialect X]"), 
...
React.createElement("h2", {id: "acknowledgements"}, "Acknowledgements and Notes"), 
