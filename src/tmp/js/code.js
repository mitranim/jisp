...
React.DOM.div({className: "row-code", style: this.state.style}, 

    React.DOM.textarea({className: "form-control form-code", 
              defaultValue: this.props.children.toString(), 
              onChange: this.reCompile, 
              style: this.state.style, 
              ref: "src"}), 

    React.DOM.pre({className: 'form-code' + (this.state.error  ? ' error'  :
    ...
    React.DOM.button({className: 'btn btn-sm btn-default btn-eval' +
