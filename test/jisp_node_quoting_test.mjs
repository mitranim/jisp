...
import * as jnio from '../js/jisp_node_ident_oper.mjs'
...
const $_gen_1 = "\\n[use \\"jisp:prelude.mjs\\" *]\\n\\n[quote 10]\\n[quote 20]\\n[quote \\"some_text_0\\"]\\n[quote \\"some_text_1\\"]\\n";
import * as $_gen_2 from "${rel(`../js/jisp_span.mjs`)}";
import * as $_gen_3 from "${rel(`../js/jisp_node_num.mjs`)}";
import * as $_gen_4 from "${rel(`../js/jisp_node_str.mjs`)}";
`)
...
import * as $_gen_3 from "../js/jisp_span.mjs";
import * as $_gen_4 from "../js/jisp_node_num.mjs";
import * as $_gen_5 from "../js/jisp_node_str.mjs";
`)
})
