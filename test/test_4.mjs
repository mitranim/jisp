...
import * as j from '../js/jisp_4.mjs'
...
await t.test(async function test_Module() {
  const fs = new j.DenoFs().setSrc(`test`).setTar(`.tmp_4`)
  ...
  */
  ...
  // const mod = await root.initModule(`test_3_use.jisp`)
