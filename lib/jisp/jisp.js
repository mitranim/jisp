(function() {
    ...
    if (isTopLevel) {
      ...
      for (_i2 = 0; _i2 < _ref10.length; ++_i2) {
        ...
        if (((!([].indexOf.call(outerScope.hoist, name) >= 0)) && (!([].indexOf.call(args, name) >= 0)))) {
          if ((([].indexOf.call(Object.keys(toplevel), name) >= 0) || ([].indexOf.call(Object.keys(opFuncs), name) >= 0) || ([].indexOf.call(Object.keys(macros), name) >= 0))) {
      ...
      if (((typeof isTopLevel !== 'undefined' && isTopLevel !== null) && isTopLevel)) {
        ...
        while ((funcs.length > 0)) {
          ...
          if (([].indexOf.call(Object.keys(toplevel), func) >= 0)) {
            ...
            _ref19 = buffer.unshift(("var " + func + " = " + macros[func] + ";"));
  ...
  (specials.quote = (function(form, scope, opts) {
    ...
    if ((isAtom(form) && (!util.isPrimitive(form)))) {
      _ref2 = buffer.push(JSON.stringify(form));
    } else if (isAtom(form)) {
      ...
      for (key in _ref3) {
        ...
        if ((isAtom(exp) && (!opts.macro))) {
          (_ref5 = compileGetLast(exp, buffer, scope, opts));
          form[key] = _ref5[0];
          buffer = _ref5[1];
          _ref4 = scope = _ref5[2];
        } else {
          (_ref6 = compileGetLast(["quote", exp], buffer, scope, opts));
          form[key] = _ref6[0];
          buffer = _ref6[1];
          _ref4 = scope = _ref6[2];
        }
      ...
      for (_i1 = 0; _i1 < _ref7.length; ++_i1) {
        ...
        if ((isList(exp) && ((car(exp) === "quote")) && isList(exp[1]) && ((exp[1].length === 0)))) {
          ...
          (_ref12 = compileGetLast(exp, buffer, scope, opts));
          exp = _ref12[0];
          buffer = _ref12[1];
          scope = _ref12[2];
          if ((typeof exp !== 'undefined' && exp !== null)) {
          ...
          (_ref14 = compileGetLast(exp, buffer, scope, opts));
          exp = _ref14[0];
          buffer = _ref14[1];
          scope = _ref14[2];
          if ((typeof exp !== 'undefined' && exp !== null)) {
          ...
          if ((isAtom(exp) && (!opts.macro))) {
            (_ref18 = compileGetLast(exp, buffer, scope, opts));
            exp = _ref18[0];
            buffer = _ref18[1];
            _ref17 = scope = _ref18[2];
          } else {
            (_ref19 = compileGetLast(["quote", exp], buffer, scope, opts));
            exp = _ref19[0];
            buffer = _ref19[1];
            _ref17 = scope = _ref19[2];
          }
          _ref17;
          if ((typeof exp !== 'undefined' && exp !== null)) {
            _ref110 = arr.push(exp);
          } else {
            _ref110 = undefined;
          }
          _ref8 = _ref110;
  ...
  (specials.fn = (function(form, scope, opts) {
    ...
    for (i = 0; i < _ref3.length; ++i) {
      ...
      if (isList(arg)) {
        ...
        if (((car(arg) === "spread"))) {
          ...
          (restind = i);
          (args[i] = restname);
          _ref5 = (rest = list((name + " = " + args.length + " <= arguments.length ? [].slice.call(arguments, " + i + ", " + ind + " = arguments.length - " + (args.length - i - 1) + ") : (" + ind + " = " + restind + ", [])")));
        } else {
    ...
    _res;
    if ((typeof restind !== 'undefined' && restind !== null)) {
      _ref10 = (args = args.slice(0, restind));
    } else {
      _ref10 = undefined;
    }
    _ref10;
    if ((optionals.length > 0)) {
      _ref11 = (body = [].concat(["do"]).concat(optionals).concat([body]));
    } else {
      _ref11 = undefined;
    }
    _ref11;
    (body = returnify(body));
    (_ref12 = compileResolve(body, buffer, scope, opts));
    body = _ref12[0];
    buffer = _ref12[1];
    scope = _ref12[2];
    if (rest) {
      _ref13 = (_ref14 = body).unshift.apply(_ref14, [].concat(rest));
    } else {
      _ref13 = undefined;
    }
    _ref13;
    ...
    _res0 = [];
    _ref16 = scope.hoist;
    for (_i3 = 0; _i3 < _ref16.length; ++_i3) {
      name = _ref16[_i3];
      if (((!([].indexOf.call(outerScope.hoist, name) >= 0)) && (!([].indexOf.call(args, name) >= 0)))) {
        if ((([].indexOf.call(Object.keys(toplevel), name) >= 0) || ([].indexOf.call(Object.keys(opFuncs), name) >= 0) || ([].indexOf.call(Object.keys(macros), name) >= 0))) {
          _ref18 = funcs.push(name);
        } else {
          _ref18 = vars.push(name);
        }
        _ref17 = _ref18;
      } else {
        _ref17 = undefined;
    ...
    _res0;
    _res1 = [];
    _ref19 = scope.service;
    for (_i4 = 0; _i4 < _ref19.length; ++_i4) {
      name = _ref19[_i4];
      if ((!([].indexOf.call(outerScope.service, name) >= 0))) {
        _ref110 = vars.push(name);
      } else {
        _ref110 = undefined;
      }
      _res1.push(_ref110);
    ...
    if (((typeof isTopLevel !== 'undefined' && isTopLevel !== null) && isTopLevel)) {
      ...
      while ((funcs.length > 0)) {
        ...
        _ref114;
        if (([].indexOf.call(Object.keys(toplevel), func) >= 0)) {
          _ref115 = body.unshift(toplevel[func].toString());
        } else if (([].indexOf.call(Object.keys(macros), func) >= 0)) {
          _ref115 = body.unshift(("var " + func + " = " + macros[func] + ";"));
        } else if (([].indexOf.call(Object.keys(opFuncs), func) >= 0)) {
          _ref115 = body.unshift(("var " + opFuncs[func].name + " = " + opFuncs[func].func + ";"));
        } else {
          throw Error(("unrecognised func: " + pr(func)));
          _ref115 = undefined;
        }
      ...
      _res4 = [];
      _ref116 = funcs;
      for (_i5 = 0; _i5 < _ref116.length; ++_i5) {
        func = _ref116[_i5];
        if ((!([].indexOf.call(outerScope.hoist, func) >= 0))) {
          _ref117 = outerScope.hoist.push(func);
        } else {
          _ref117 = undefined;
        }
        _res4.push(_ref117);
