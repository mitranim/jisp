(function() {
  ...
  var vm, fs, path, beautify, extend, toplevel, util, ops, operators, opFuncs, tokenise, lex, parse, isAtom, isHash, isList, isVarName, isIdentifier, specials, macros;
  ...
  function render(buffer) {
    var i, exp, _ref, _res, _ref0, _ref1;
    if (((buffer.length === 0))) {
      _ref = ""
      ...
      for (i = 0; i < _ref0.length; ++i) {
        ...
        if (((isList(exp) && ((exp.length === 0))) || (((typeof exp) === "undefined")) || ((exp === "")))) {
          _ref1 = (buffer[i] = undefined)
        } else if ((util.isPrimitive(exp) || (!/:$|\}$|;$/.test(exp.slice(-1))))) {
          _ref1 = (buffer[i] += ";")
        } else {
          _ref1 = undefined
        }
  ...
  function assertArg(exp, test, expect) {
    ...
    if (test(exp)) {
      ...
      throw Error(("expecting " + expect + ", got " + exp));
      _ref0 = undefined;
    }
    return _ref0;
  }
      ...
      if (([].indexOf.call(Object.keys(specials), car(form)) >= 0)) {
        ...
        if ((!(typeof argsSpread !== 'undefined' && argsSpread !== null))) {
          if (([].indexOf.call(Object.keys(operators), first) >= 0)) {
            ...
            _ref14 = buffer.push((first + "(" + form.spread() + ")"))
          }
          _ref13 = _ref14;
        } else {
          (form = ["quote", form]);
          ...
          scope = _ref16[2];
          if (([].indexOf.call(Object.keys(operators), first) >= 0)) {
            if ((([].indexOf.call(Object.keys(opFuncs), first) >= 0) && opFuncs[first].spread())) {
              assertArg(first, isVarName, "valid identifier");
              (scope = declareVar(first, scope));
              _ref18 = (first = opFuncs[first].name);
            } else {
              throw Error((first + " can't spread arguments (yet)"));
              _ref18 = undefined;
            }
            _ref17 = _ref18;
          } else {
          ...
          method = _ref19[1];
          if (((first === name))) {
            _ref110 = buffer.push((name + ".apply(" + name + ", " + form + ")"))
          } else {
            (_ref111 = declareService("_ref", scope));
            collector = _ref111[0];
            scope = _ref111[1];
            _ref110 = buffer.push(("(" + collector + " = " + name + ")" + method + ".apply(" + collector + ", " + form + ")"));
          }
          _ref13 = _ref110;
        }
        _ref5 = _ref13;
      ...
      if (((typeof isTopLevel !== 'undefined' && isTopLevel !== null) && isTopLevel)) {
        ...
        while ((funcs.length > 0)) {
          ...
          if (([].indexOf.call(Object.keys(toplevel), func) >= 0)) {
            ...
            throw Error(("unrecognised func: " + func));
            _ref19 = undefined;
          }
          _res3.push(_ref19);
        }
  ...
  (specials.quote = (function(form, scope, opts) {
    ...
    (formName = form.shift());
    if ((form.length < 1)) {
      throw Error((formName + " expects no less than " + 1 + " arguments"));
      _ref0 = undefined;
    } else {
      _ref0 = undefined
    }
    _ref0;
    if ((form.length > 1)) {
      throw Error((formName + " expects no more than " + 1 + " arguments"));
      _ref1 = undefined;
    } else {
      _ref1 = undefined
    }
        ...
        if ((isList(left) && ((car(left) === "get")))) {
          ...
          for (i = 0; i < _ref10.length; ++i) {
            ...
            if (((car(name) === "spread"))) {
              ...
              _ref15;
              _ref11 = buffer.push((name + " = " + ref + "[" + ind + "++]"));
            }
            _res0.push(_ref11);
          }
          _ref4 = _res0;
  ...
  (specials.fn = (function(form, scope, opts) {
    ...
    for (i = 0; i < _ref3.length; ++i) {
      ...
      if (isList(arg)) {
        ...
        _ref4 = rest.push((arg + " = arguments[" + ind + "++]"))
      } else {
        _ref4 = undefined
      }
      _res.push(_ref4);
    ...
    _ref112;
    (scope = outerScope);
    buffer.push(("(function(" + args.spread() + ") {" + render(body) + " })"));
    return Array(buffer, scope);
  }));
  (specials.def = (function(form, scope, opts) {
    ...
    _ref112;
    (scope = outerScope);
    buffer.push(("function " + fname + "(" + args.spread() + ") {" + render(body) + " }"));
    buffer.push(fname);
    return Array(buffer, scope);
  }));
  (specials.if = (function(form, scope, opts) {
    ...
    function collect(compiled, collector, isCase) {
      var plug, lastStr, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if ((isList(compiled) && (compiled.length > 0))) {
        ...
        _ref6;
        (lastStr = compiled.pop());
        if (/^return\s/.test(lastStr)) {
          _ref7 = (lastStr = lastStr.replace(/^return\s/, ("return " + collector + " = ")))
        } else if (util.kwtest(lastStr)) {
          _ref7 = (lastStr = (collector + " = undefined; " + lastStr))
        } else {
          _ref7 = (lastStr = (collector + " = " + lastStr))
        }
        _ref7;
        compiled.push(lastStr);
    ...
    for (i = 0; i < _ref7.length; ++i) {
      ...
      _ref10;
      if ((midtest.length > 1)) {
        throw Error(('elif' + " must compile to single expression (todo fix later); got:" + midtest));
        _ref11 = undefined;
      } else {
        _ref11 = undefined
      }
    ...
    (comp = ("if (" + predicate + ") { " + render(prebranch) + " } "));
    _res0 = [];
    _ref14 = midcases;
    for (_i7 = 0; _i7 < _ref14.length; ++_i7) {
      mid = _ref14[_i7];
      _res0.push((comp += (" else if (" + mid.test.spread() + ") { " + render(mid.branch) + " }")))
    }
    _res0;
  ...
  (specials.switch = (function(form, scope, opts) {
    ...
    for (i = 0; i < _ref6.length; ++i) {
      ...
      _ref9;
      if ((midtest.length > 1)) {
        throw Error(("case" + " must compile to single expression (todo fix later); got:" + midtest));
        _ref10 = undefined;
      } else {
        _ref10 = undefined
      }
    ...
    scope = _ref12[2];
    (postbranch = collect(postbranch, collector));
    (comp = ("switch (" + predicate + ") { "));
    _res0 = [];
    _ref13 = midcases;
    for (_i6 = 0; _i6 < _ref13.length; ++_i6) {
      mid = _ref13[_i6];
      _res0.push((comp += (" case " + mid.test.spread() + ": " + render(mid.branch))))
    }
    _res0;
  ...
  (specials.for = (function(form, scope, opts) {
    ...
    (formName = form.shift());
    if ((form.length < 2)) {
      throw Error((formName + " expects no less than " + 2 + " arguments"));
      _ref0 = undefined;
    } else {
      _ref0 = undefined
    }
    _ref0;
    if ((form.length > 4)) {
      throw Error((formName + " expects no more than " + 4 + " arguments"));
      _ref1 = undefined;
    } else {
      _ref1 = undefined
    }
    ...
    if ((!(typeof body !== 'undefined' && body !== null))) {
      if ((!(typeof iterable !== 'undefined' && iterable !== null))) {
        if ((isNaN(Number(value)) || (!(parseInt(value) > 0)))) {
          throw Error(("expecting integer, got " + value));
          _ref5 = undefined;
        } else {
          _ref5 = undefined
        }
    ...
    buffer = _ref17[1];
    scope = _ref17[2];
    body.push((collector + ".push(" + body.pop() + ")"));
  ...
  (specials.while = (function(form, scope, opts) {
    ...
    _ref0;
    if ((form.length > 3)) {
      throw Error((formName + " expects no more than " + 3 + " arguments"));
      _ref1 = undefined;
    } else {
      _ref1 = undefined
    }
    ...
    _ref3;
    (_ref6 = compileResolve(test, buffer, scope, opts));
    test = _ref6[0];
    buffer = _ref6[1];
    scope = _ref6[2];
    ...
    scope = _ref7[2];
    if (((form.length === 2))) {
      _ref8 = body.push((collector + ".push(" + body.pop() + ")"))
    } else {
      _ref8 = undefined
    }
    _ref8;
    buffer.push(("while (" + render(test) + ") { " + render(body) + " }"));
    if (((form.length === 2))) {
  ...
  (specials.try = (function(form, scope, opts) {
    ...
    buffer = _ref11[1];
    scope = _ref11[2];
    catchForm.push((ref + " = " + catchForm.pop()));
    if ((typeof finalForm !== 'undefined' && finalForm !== null)) {
      ...
      buffer = _ref14[1];
      scope = _ref14[2];
      _ref12 = finalForm.push((ref + " = " + finalForm.pop()));
    } else {
      _ref12 = undefined
    }
    _ref12;
    (res = ("try { " + render(tryForm) + " } catch (" + err + ") { " + render(catchForm) + " }"));
    if ((typeof finalForm !== 'undefined' && finalForm !== null)) {
  ...
  (specials.get = (function(form, scope, opts) {
    ...
    _ref0;
    if ((form.length > 2)) {
      throw Error((formName + " expects no more than " + 2 + " arguments"));
      _ref1 = undefined;
    } else {
      _ref1 = undefined
    }
    ...
    if (isVarName(property)) {
      _ref6 = buffer.push((object + "." + property))
    } else {
      _ref6 = buffer.push((object + "[" + property + "]"))
    }
    _ref6;
  ...
  (specials.spread = (function(form, scope, opts) {
    ...
    if (isList(form)) {
      ...
      throw Error(("spread requires atom, got: " + form));
      _ref2 = undefined;
    }
    _ref2;
    return Array(buffer, scope);
