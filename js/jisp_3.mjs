...
export class MixErr extends a.DedupMixinCache {
  static make(cls) {
    return class MixErr extends cls {
...
export class MixOwnSpanned extends a.DedupMixinCache {
  static make(cls) {
    return class MixOwnSpanned extends MixErr.goc(cls) {
      #span = undefined
...
export class MixOwnNodeSourced extends a.DedupMixinCache {
  static make(cls) {
    return class MixOwnNodeSourced extends MixErr.goc(cls) {
      #srcNode = undefined
...
export class MixParent extends a.DedupMixinCache {
  static make(cls) {
    return class MixParent extends MixErr.goc(cls) {
      toValidChild(val) {
        val.setParent(this)
...
export class MixChild extends a.DedupMixinCache {
  static make(cls) {
    return class MixChild extends MixErr.goc(cls) {
      #parent = undefined
...
export class MixPrinted extends a.DedupMixinCache {
  static make(cls) {
    return class MixPrinted extends MixChild.goc(cls) {
      ownPrn() {}
...
export class MixOwnPrinted extends a.DedupMixinCache {
  static make(cls) {
    return class MixOwnPrinted extends MixPrinted.goc(cls) {
      #prn = undefined
      ownPrn() {return this.#prn}
      optPrn() {return this.#prn}
      setPrn(val) {return this.#prn = this.reqInst(val, Prn), this}
    }
  }
}
...
export class MixNamed extends a.DedupMixinCache {
  static make(cls) {
    return class MixNamed extends MixErr.goc(cls) {
      ownName() {}
      optName() {}
      reqName() {
        return (
...
export class MixValued extends a.DedupMixinCache {
  static make(cls) {
    return class MixValued extends MixErr.goc(cls) {
      ownVal() {}
      optVal() {}
      reqVal() {
        return (
...
export class MixScoped extends a.DedupMixinCache {
  static make(cls) {
    return class MixScoped extends MixErr.goc(cls) {
      ownScope() {}
...
export class MixOwnScoped extends a.DedupMixinCache {
  static make(cls) {
    return class MixOwnScoped extends MixParent.goc(MixScoped.goc(cls)) {
      #scope = undefined
...
*/
export class Node extends MixScoped.goc(MixRef.goc(MixPrinted.goc(
...
*/
export class Predecl extends PredefNode {
...
export class Macro extends PredefNode {
  static def() {return super.def().setCallStyle(CallStyle.list)}
...
export class MixMixable extends a.DedupMixinCache {
  static make(cls) {
    return class MixMixable extends MixErr.goc(cls) {
      #mixins = undefined
...
export class Module extends MixOwnValued.goc(MixOwnScoped.goc(NodeList)) {
  ...
  */
  ...
  compileBody() {return this.reqPrn().compileStatements(this)}
...
export class MixPromiseCached extends a.DedupMixinCache {
  static make(cls) {
    return class MixPromiseCached extends MixErr.goc(cls) {
...
/*
FIXME: instead of global temp dirs, use a local dir, such as `./.tmp` or
`./.target`.
*/
export class DenoFs extends Fs {
  ...
  cacheDirName() {return CACHE_DIR_NAME}

  async mock(url) {
    const rel = new Url(url).simple()
    console.log(`rel:`, rel)

    const dirPath = io.paths.join(await this.cacheDir(), rel)
  ...
  #cacheDir = undefined
  async cacheDir() {return this.#cacheDir ??= await this.findCacheDir()}

  async findCacheDir() {return io.paths.join(await this.tempDir(), this.cacheDirName())}

  #tempDir = undefined
  async tempDir() {return this.#tempDir ??= await this.findTempDir()}

  async findTempDir() {
    const path = await Deno.makeTempFile()
    const dir = io.paths.dir(path)
    Deno.remove(path).catch(a.nop)
    return dir
  }
}
...
*/
export class Root extends MixOwnPrinted.goc(MixParent.goc(MixErr.goc(a.Emp))) {
  #fs = undefined
